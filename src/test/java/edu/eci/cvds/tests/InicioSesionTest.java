...
public class InicioSesionTest {
    ...
    public void deberiaConsultarInformacionDeUsuarioConCorreo(){
        try {
            Assert.assertEquals(serviciosBiblioteca.consultarUsuario("hawaii50@mail.com").toString(), "Usuario{correo=hawaii50@mail.com, nombre=Mohammed, apellido=McLovin, tipo=1}");
